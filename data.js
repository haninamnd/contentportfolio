  ...
  projects: [
    {
      ...
      media: [
        { type: "video", src: "assets/pln-video-1.mp4", label: "PLN video 01" },
        { type: "video", src: "assets/pln-video-2.mp4", label: "PLN video 02" }
      ],
      contributions: [
...

    {
      ...
      media: [
        { type: "image", src: "assets/Sanggar2.png", label: "Sanggar Ungu Case Study Document" },
        { type: "image", src: "assets/sanggar-ungu-screenshot.jpg", label: "Sanggar Ungu Instagram content screenshot" }
      ],
      contributions: [
